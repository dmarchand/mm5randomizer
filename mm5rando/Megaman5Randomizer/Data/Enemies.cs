...
namespace Megaman5Randomizer.Data
{
    public class Enemies
    {
        public static List<Enemy> EnemyData = new List<Enemy>() {
            new Enemy(0x00, "Pukapuka", 4, false, false, false, false, false, false, false),
            ...
            new Enemy(0x03, "Met Astronaut", 0, false, false, false, false, false, false),
            ...
            new Enemy(0x08, "Metturret", -4, false, false, false, false, false, false),
            new Enemy(0x09, "Mettrain", 0, true, false, false, false, false, false),
            new Enemy(0x0B, "Buoy", 0, false, false, false, true, false, false),
            new Enemy(0x0C, "Power Muscler", -0x0F, false, false, false, false, false, true),
            ...
            new Enemy(0x2B, "Bouncy Guy", -2, false, false, false, false, false, true),
            new Enemy(0x2C, "Scooper", 4, false, false, false, false, false, false),
            ...
            new Enemy(0x31, "Met Mother", 7, false, false, false, false, false, false),
            new Enemy(0x32, "Warning Cone", 4, false, false, false, false, false, false),
            new Enemy(0x33, "Ton Dale", 0, false, false, false, false, false, false),
            ...
            new Enemy(0x36, "Pike Berry", 0, false, false, false, false, false, false),
            new Enemy(0x37, "Missile", 0, false, false, false, false, false, false),
            new Enemy(0x38, "Orbiter", 0, false, false, false, false, false, false),
            ...
            new Enemy(0x61, "Lyric", 0, false, false, false, false, false, false),
