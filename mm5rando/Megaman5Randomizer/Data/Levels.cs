...
namespace Megaman5Randomizer.Data
{
    public class Levels
    {
        public static List<Level> LevelData = new List<Level>() {
            ...
            new Level(18320, 0x10B90, 0x07, "Protoman 1"),
            new Level(20320, 0x12B90, 0x07, "Protoman 2"),
            new Level(22320, 0x14B90, 0x07, "Protoman 3"),
            new Level(24320, 0x16B90, 0x07, "Protoman 4"),
            new Level(24320, 0x18B90, 0x07, "Wily Castle 1"),
            new Level(24320, 0x1AB90, 0x07, "Wily Castle 2"),
            new Level(24320, 0x1CB90, 0x07, "Wily Castle 3"),
            new Level(24320, 0x1EB90, 0x07, "Wily Castle 4")
        };
    }
}
